      			...
      			<div class="content-box">
        				<div class="item">
                            ...
                            <div class="name-parent">
                                ...
                                <div class="input1">
                                    <input class="input" type="text" placeholder="수정할 닉네임을 입력해주세요">
                                </div>
                           </div>
                           ...
                           <div class="pw-parent">
                            ...
                            <div class="input1">
                                <input class="input" type="password" minlength="8" placeholder="8자리 이상의 비밀번호를 입력해주세요">
                            </div>
                      </div>
                      <div class="input-group">
                            <div class="input1">
                                <input class="input" type="password" placeholder="수정할 비밀번호 재입력해주세요">
                            </div>
